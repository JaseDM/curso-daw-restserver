...
router.delete('/:id', [
        validarJWT, // Validación de token
        rolesValidos('ADMIN_ROLE', 'VENTAS_ROLE'), // Valida que el rol sea uno de los establecidos como parámetro
        //roleAdmin, // Valida que el usuario tenga rol de adminitrador
        check('id', 'La id no es válida').isMongoId(),
        check('id').custom( existeUsuarioPorId ),
        validarCampos
